...
const TopCards = () => {
  return (
    <div className='grid lg:grid-cols-5 gap-4 p-4'>
        <div className='lg:col-span-2 col-span-1 bgwhite flex justify-between w-full border p-4 rounded-lg'>
        ...
        <div className='bgwhite flex justify-between w-full border p-4 rounded-lg'>
            <div className='flex flex-col w-full pb-4'>
